...
public class CorprateActivity extends AppCompatActivity {
    private Toolbar toolbarlogin;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_corprate);
        ...
        toolbarlogin.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(CorprateActivity.this,AboutActivity.class);
